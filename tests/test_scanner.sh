...
expect_contains "$version_output" "VISTA 0.4.0" "version output"

help_output="$($binary --help)"
expect_contains "$help_output" "Usage: vista <source.vista> --emit <tokens|ast|symbols|diagnostics>" "help usage"
